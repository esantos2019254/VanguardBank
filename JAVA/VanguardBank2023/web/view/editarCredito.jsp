    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                ...
                %>
                <h1 class="container text-center">Editar Credito</h1>
                <form action="Controlador">
                    <strong>Monto del Credito</strong>
                    <input type="text" name="txtMontoCredito" value="<%=nuevoCredito.getMontoCredito()%>" class="form-control"><br><br>
                    <strong>Fecha y Hora</strong>
                    <input type="datetime-local" name="txtFechaHora" value="<%=nuevoCredito.getFechaHora()%>" class="form-control"><br><br>
                    <strong>Interes Creditario</strong>
                    <input type="text" name="txtInteresCredito" value="<%=nuevoCredito.getInteresCredito()%>" class="form-control"><br><br>
                    <strong>ID de la Cuenta </strong>
                    <input type="text" name="txtIdCuenta" value="<%=nuevoCredito.getIdCuenta()%>" class="form-control"><br><br>
                    <input type="hidden" name="txtIdCredito" value="<%=nuevoCredito.getIdCredito()%>"><br>
                    <input type="submit" name="accion" value="ActualizarCredito" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
