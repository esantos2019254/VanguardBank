...
<html>
    ...
    <body>
        ...
        <div class="container-sm mb-4 mt-4">
            <h1 class="container text-center">Llene los espacios con sus datos:</h1>
            <form action="Controlador">
                <label for="nombres">Nombres:</label>
                <input type="text" id="nombres" name="txtNombres" class="form-control"></text><br>
                <label for="apellidos">Apellidos:</label>
                <input type="text" id="apellidos" name="txtApellidos" class="form-control" /><br>
                <label for="fechaDeContratacion">Fecha de contratación:</label>
                <input type="date" id="fechaDeContratacion" name="dFechaContratacion" class="form-control"><br>
                <label for="direccion">Dirección:</label>
                <input type="text" id="direccion" name="txtDireccion" class="form-control"><br>
                <label for="numeroContacto">Número de teléfono:</label>
                <input type="text" id="numeroContacto" name="txtNumeroContacto" class="form-control"><br>
                <label for="idTipoEmpleado">Id tipo de Empleado:</label>
                <input type="text" name="txtIdTipoEmpleado" id="idTipoEmpleado" class="form-control"><br>
                <button type="submit" name="accion" value="AgregarEmpleado" class="form-control btn bg-success">Agregar</button>
            </form>
        </div>
