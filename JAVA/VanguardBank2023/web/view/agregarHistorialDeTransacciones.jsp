...
<html>
    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <h1 class="container text-center">Agregar Historial de Transacciones</h1>
            <form action="Controlador">
                <strong>Id Cuenta:</strong>
                <input type="text" name="txtIdCuenta" class="form-control"><br><br>
                <strong>Id Transaccion:</strong>
                <input type="text" name="txtTransaccion" class="form-control"><br><br>
                <input type="submit" name="accion" value="AgregarHistorial" class="form-control btn btn-success">
            </form>
        </div>
