...
<html>
    ...
    <body>
        ...
        <div class="container-sm mb-4 mt-4">
            <h1 class="container text-center">Agregar Tipo Moneda</h1>
            <form action="Controlador">
                <strong>simboloMoneda</Strong><br>
                <input type="text" name="txtSimboloMoneda" class="form-control"><br><br>
                <strong>nombreMoneda</strong><br>
                <input type="text" name="txtNombreMoneda" class="form-control"><br><br>
                <strong>conversionDolar</strong><br>
                <input type="text" name="txtConversionDolar" class="form-control"><br><br>
                <input type="submit" name="accion" value="AgregarTipoMoneda" class="form-control btn bg-success">
            </form>
        </div>
        <br>
        <br>
