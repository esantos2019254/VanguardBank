...
<html>
    ...
    <body>
        ...
        <div class="container-md mt-4 mb-4">
            <h1 class="container text-center">Agregar Tipo Empleado</h1>
            <form action="Controlador">
                <strong>Puesto</strong><br>
                <input type="text" name="txtPuesto" class="form-control"><br><br>
                <strong>Salario</strong><br>
                <input type="text" name="txtSalario" class="form-control"><br><br>
                <strong>Contrato</strong><br>
                <input type="text" name="txtContrato" class="form-control"><br><br>
                <input type="submit" name="accion" value="AgregarTipoEmpleado" class="form-control btn btn-success"><br><br>
            </form>
        </div>
        <br>
        <br>
