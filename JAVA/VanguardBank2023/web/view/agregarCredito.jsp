...
<html>
    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <h1 class="container text-center">Agregar Credito</h1>
            <form action="Controlador">
                <strong>Monto del Credito:</strong><br>
                <input type="text" name="txtMontoCredito" class="form-control"><br><br>
                <strong>Fecha y Hora</strong><br>
                <input type="datetime-local" name="txtFechaHora" class="form-control"><br><br>
                <strong>Interes Creditario</strong><br>
                <input type="text" name="txtInteresCredito" class="form-control"><br><br>
                <strong>Id Cuenta</strong><br>
                <input type="text" name="txtIdCuenta" class="form-control"><br><br>
                <input type="submit" name="accion" value="AgregarCredito" class="form-control btn btn-success"><br><br>
            </form>
        </div>
