    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                ...
                %>
                <h1 class="container text-center">Editar Un Tipo Empleado</h1>
                <form action="Controlador">
                    <strong>simboloMoneda</strong><br>
                    <input type="text" name="txtSimboloMoneda" value="<%=nuevoTipoMoneda.getSimboloMoneda()%>" class="form-control"><br><br>
                    <strong>nombreMoneda</strong><br>
                    <input type="text" name="txtNombreMoneda" value="<%=nuevoTipoMoneda.getNombreMoneda()%>" class="form-control"><br><br>
                    <strong>conversionDolar</strong><br>
                    <input type="text" name="txtConversionDolar" value="<%=nuevoTipoMoneda.getConversionDolar()%>" class="form-control"><br><br>
                    <input type="hidden" name="txtIdTipoMoneda" value="<%=nuevoTipoMoneda.getIdTipoMoneda()%>" class="form-control"><br>
                    <input type="submit" name="accion" value="ActualizarTipoMoneda" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
        <br>
