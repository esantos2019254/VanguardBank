...
<html>
    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <h1 class="container text-center">Agregar Proveedor</h1>
            <form action="Controlador">
                ...
                <input type="text" name="txtCorreo" class="form-control"><br><br>
                <strong>Telefono:</strong><br>
                <input type="text" name="txtTelefono" class="form-control"><br><br>
                <input type="submit" name="accion" value="AgregarProveedor" class="form-control btn btn-success"><br><br>
            </form>
        </div>
        <br>
        <br>
