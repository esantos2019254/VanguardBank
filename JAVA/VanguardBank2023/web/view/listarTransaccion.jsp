...
<html>
    ...
    <body>
        ...
        <div class="container-fluid mb-4 mt-4">
            <h1 class="container text-center">Registro de Transacciones</h1>
            <a class="btn btn-primary mb-4" href="Controlador?accion=addTransaccion">Agregar Nueva Transaccion</a>
            <table border="1" class="table table-striped-columns table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="Controlador?accion=editTransaccion&idTransaccion=<%= trn.getIdTransaccion()%>">Edit</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminarTransaccion&idTransaccion=<%= trn.getIdTransaccion()%>">Eliminar</a>
