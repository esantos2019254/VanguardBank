<%-- 
    ...
    Created on : Jul 21, 2023, 8:49:21 PM
    Author     : okrun
--%>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                <%
                    ...
                    int idSucursal = Integer.parseInt((String) request.getAttribute("idSucu"));
                    Sucursal nuevaSucursal = (Sucursal) nuevaSucursalDAO.buscar(idSucursal);
                %>
                <h1 class="container text-center">EDITAR SUCURSAL</h1>
                <form action="Controlador">
                    <strong>NOMBRE SUCURSAL</strong><br>
                    <input type="text" name="txtNombreSucursal" value="<%=nuevaSucursal.getNombreSucursal()%>" class="form-control"><br><br>
                    <strong>DIRECCION SUCURSAL</strong><br>
                    <input type="text" name="txtDireccionSucursal" value="<%=nuevaSucursal.getCorreoSucursal()%>" class="form-control"><br><br>
                    <strong>CORREO SUCURSAL</strong><br>
                    <input type="text" name="txtCorreoSucursal" value="<%=nuevaSucursal.getDireccionSucursal()%>" class="form-control"><br><br>
                    <input type="hidden" name="txtIdSucursal" value="<%=nuevaSucursal.getIdSucursal()%>" class="form-control"><br>
                    <input type="submit" name="accion" value="ActualizarSucursal" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
        <br>
