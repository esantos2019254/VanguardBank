        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                ...
                <form action="Controlador">
                    ...
                    <input type="text" name="txtPuesto" value="<%=nuevoTipoEmpleado.getNombreTipoPuesto()%>" class="form-control"><br><br>
                    <strong>Salario</strong><br>
                    <input type="text" name="txtSalario" value="<%=nuevoTipoEmpleado.getSalarioTipoEmpleado()%>" class="form-control"><br><br>
                    <strong>Contrato</strong><br>
                    <input type="text" name="txtContrato" value="<%=nuevoTipoEmpleado.getContratoTipoEmpleado()%>" class="form-control"><br><br>
                    <input type="hidden" name="txtID" value="<%=nuevoTipoEmpleado.getIdTipoEmpleado()%>" class="form-control"><br>
                    <input type="submit" name="accion" value="ActualizarTipoEmpleado" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
        <br>
