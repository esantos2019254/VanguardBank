...
<html>
    ...
    <body>
        ...
        <div class="container-fluid mb-4 mt-4">
            <h1 class="container text-center">REGISTRO DE EMPLEADOS</h1>
            <a class="btn btn-primary mb-4" href="Controlador?accion=addEmpleado">Agregar Empleado</a>
            <table border="1" class="table table-striped-columns table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning mb-3" href="Controlador?accion=editEmpleado&idEmpleado=<%= empleado.getIdEmpleado()%>">Editar</a><br>
                            <a class="btn btn-danger" href="Controlador?accion=delEmpleado&idEmpleado=<%= empleado.getIdEmpleado()%>">Eliminar</a><br>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
