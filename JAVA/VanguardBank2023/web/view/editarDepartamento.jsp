    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                ...
                %>
                <h1 class="container text-center">Editar un Departamento</h1>
                <form action="Controlador">
                    <strong>Nombre Departamento:</strong><br>
                    <input type="text" name="txtNombreDepartamento" value="<%=nuevoDepartamento.getNombreDepartamento()%>" class="form-control"><br><br>
                    <strong>Código Postal:</strong><br>
                    <input type="text" name="txtCodigoPostal" value="<%=nuevoDepartamento.getCodigoPostal()%>" class="form-control"><br><br>
                    <strong>Fecha Apertura:</strong><br>
                    <input type="date" name="txtFechaApertura" value="<%=nuevoDepartamento.getFechaApertura()%>" class="form-control"><br><br>
                    <input type="hidden" name="txtIdDepartamento" value="<%=nuevoDepartamento.getIdDepartamento()%>"><br>
                    <input type="submit" name="accion" value="ActualizarDepartamento" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
        <br>
