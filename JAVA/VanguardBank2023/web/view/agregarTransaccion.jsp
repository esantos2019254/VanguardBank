...
<html>
    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <h1 class="container text-center">Agregar Transaccion</h1>
            <form action="Controlador">
                <strong>Tipo de transaccion:</strong><br>
                <input type="text" name="txtTipoTransaccion" class="form-control"><br><br>
                <strong>Monto</strong><br>
                <input type="text" name="txtMontoTransaccion" class="form-control"><br><br>
                <strong>Fecha y Hora de Transaccion</strong><br>
                <input type="datetime-local" name="txtFechaHora" style="font-family: Bodoni MT" class="form-control"><br><br>
                <strong>Codigo del Empleado</strong><br>
                <input type="text" name="txtIdEmpleado" class="form-control"><br><br>
                <strong>Codigo de la Cuenta</strong><br>
                <input type="text" name="txtIdCuenta" class="form-control"><br><br>
                <input type="submit" name="accion" value="AgregarTransaccion" class="form-control btn btn-success"><br><br>
            </form>
        </div>
