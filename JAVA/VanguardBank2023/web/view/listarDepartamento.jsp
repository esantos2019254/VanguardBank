...
<html>
    ...
    <body>
        ...
        <div class="container-md mt-4 mb-3">
            <h1 class="container text-center">Registro de Departamento</h1>
            <a class="btn btn-primary mb-4" href="Controlador?accion=addDepartamento">Agregar nuevo Departamento</a>
            <table border="1" class="table table-striped-columns table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="Controlador?accion=editDepartamento&idDepartamento=<%= depa.getIdDepartamento()%>">Edit</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminarDepartamento&idDepartamento=<%= depa.getIdDepartamento()%>">Delete</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
