    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                ...
                %>
                <h1 class="container text-center">Editar un historial de transacciones</h1>
                <form action="Controlador">
                    <strong>ID Cuenta</strong><br>
                    <input type="text" name="txtIdCuenta" value="<%=nuevoHistorial.getIdCuenta()%>" class="form-control"><br><br>
                    <strong>ID Transacción</strong><br>
                    <input type="text" name="txtIdTransaccion" value="<%=nuevoHistorial.getIdTransaccion()%>" class="form-control"><br>
                    <input type="hidden" name="txtIdHistorialTransacion" value="<%=nuevoHistorial.getIdHistorialTransaccion()%>" class="form-control"><br>
                    <input type="submit" name="accion" value="ActualizarHistorial" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
        <br>
