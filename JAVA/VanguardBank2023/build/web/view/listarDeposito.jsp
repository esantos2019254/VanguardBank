...
<html>
    ...
    <body>
        ...
        <div class="container-md mt-4 mb-4">
            <h1 class="container text-center">Registro de Depósito</h1>
            <a class="btn btn-primary mb-4" href="Controlador?accion=addDeposito">Agregar nuevo Depósito</a>
            <table border="1" class="table table-striped-columns table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="Controlador?accion=editDeposito&idDeposito=<%= dep.getIdDeposito()%>">Edit</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminarDeposito&idDeposito=<%= dep.getIdDeposito()%>">Eliminar</a><br>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
