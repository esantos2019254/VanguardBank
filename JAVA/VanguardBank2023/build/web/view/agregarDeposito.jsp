...
<html>
    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <h1 class="container text-center">Agregar Depósito</h1>
            <form action="Controlador">
                <strong>montoDeposito:</strong>
                <input type="text" name="txtMontoDeposito" class="form-control"><br><br>
                <strong>fechaDeposito:</strong>
                <input type="text" name="txtFechaDeposito"class="form-control" ><br><br>
                <strong>horaDeposito:</strong>
                <input type="text" name="txtHoraDeposito" class="form-control"><br><br>
                <strong>idCuentaOrigen:</strong>
                <input type="text" name="txtIdCuentaOrigen" class="form-control"><br><br>
                <strong>idCuentaDeposito:</strong>
                <input type="text" name="txtIdCuentaDeposito"class="form-control"><br><br>
                <input type="submit" name="accion" value="AgregarDeposito" class="form-control btn btn-success">
            </form>
        </div>
