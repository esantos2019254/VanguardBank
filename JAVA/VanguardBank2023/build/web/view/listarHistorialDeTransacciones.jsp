...
<html>
    ...
    <body>
        ...
        <div class="container-md mt-4 mb-4">
            <h1 class="container text-center">Registro de historial de transacciones</h1>
            <a class="btn btn-primary mb-4" href="Controlador?accion=addHistorial">Agregar nuevo Depósito</a>
            <table border="1" class="table table-striped-columns table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="Controlador?accion=editarHistorial&idHistorialTransaccion=<%=dep.getIdHistorialTransaccion()%>">Edit</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminarHistorial&idHistorialTransaccion=<%=dep.getIdHistorialTransaccion()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
