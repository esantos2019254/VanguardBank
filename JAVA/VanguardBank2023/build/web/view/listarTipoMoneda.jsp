...
<html>
    ...
    <body>
        ...
        <div class="container-md">
            <h1 class="container text-center">Tipos de Monedas</h1>
            <a class="btn btn-primary mb-4" href="Controlador?accion=addTipoMoneda">Agregar Nuevo Tipo de Moneda</a><br><br>
            <table border="1" class="table table-striped-columns table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="Controlador?accion=editarTipoMoneda&idTipoMoneda=<%=tipo.getIdTipoMoneda()%>">Edit</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminarTipoMoneda&idTipoMoneda=<%=tipo.getIdTipoMoneda()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
