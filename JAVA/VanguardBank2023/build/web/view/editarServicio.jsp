<%-- 
    ...
    Created on : Jul 28, 2023, 9:50:05 AM
    Author     : okrun
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                <%
                    ServicioDAO nuevaSucursalDAO = new ServicioDAO();
                    int idSucursal = Integer.parseInt((String) request.getAttribute("idServ"));
                    Servicio nuevoServicio = (Servicio) nuevaSucursalDAO.buscar(idSucursal);
                %>
                <h1 class="container text-center">EDITAR SERVICIO</h1>
                <form action="Controlador">
                    <strong>TIPO SERVICIO:</strong><br>
                    <input type="text" name="txtTipoServicio" value="<%=nuevoServicio.getTipoServicio()%>" class="form-control"><br><br>
                    <strong>CORRELATIVO;</strong><br>
                    <input type="text" name="txtCorrelativo" value="<%=nuevoServicio.getCorrelativo()%>" class="form-control"><br><br>
                    <strong>MONTO SERVICIO</strong><br>
                    <input type="text" name="txtMontoServicio" value="<%=nuevoServicio.getMontoServicio()%>" class="form-control"><br><br>
                    <input type="hidden" name="txtIdServicio" value="<%=nuevoServicio.getIdServicio()%>" class="form-control"><br>
                    <input type="hidden" name="txtIdCuenta" value="<%=nuevoServicio.getIdCuenta()%>" class="form-control"><br>
                    <input type="submit" name="accion" value="ActualizarServicio" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
        <br>
