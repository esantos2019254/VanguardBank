...
<html>
    ...
    <body>
        ...
        <div class="container mt-4 mb-4">
            <h1 class="container text-center">Agregar Departamento</h1>
            <form action="Controlador">
                <strong>Nombre Departamento:</strong><br>
                <input type="text" name="txtNombreDepartamento" class="form-control" ><br><br>
                <strong>Código Postal:</strong><br>
                <input type="text" name="txtCodigoPostal"class="form-control" ><br><br>
                <strong>Fecha Apertura:</strong><br>
                <input type="date" name="txtFechaApertura" class="form-control" ><br><br>
                <input type="submit" name="accion" value="AgregarDepartamento" class="form-control btn btn-success"><br><br>
            </form>
        </div>
        <br>
        <br>
