<%-- 
    ...
    Created on : Jul 21, 2023, 8:35:11 PM
    Author     : okrun
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-sm mb-4 mt-4">
            <h1 class="container text-center">AGREGAR SUCURSAL</h1>
            <form action="Controlador">
                <strong>NOMBRE SUCURSAL:</strong><br>
                <input type="text" name="txtNombreSucursal" class="form-control"><br><br>
                <strong>DIRECCION SUCURSAL:</strong><br>
                <input type="text" name="txtDireccionSucursal" class="form-control"><br><br>
                <strong>CORREO SUCURSAL:</strong><br>
                <input type="text" name="txtCorreoSucursal"class="form-control"><br><br>
                <strong>ID DEPARTAMENTO</strong><br>
                <input type="text" name="txtIdDepartamento"class="form-control"><br><br>
                <strong>ID PROVEEDOR</strong><br>
                <input type="text" name="txtIdProveedor"class="form-control"><br><br>
                <input type="submit" name="accion" value="Agregar Sucursal" class="form-control btn btn-success"><br><br>
            </form>
        </div>
