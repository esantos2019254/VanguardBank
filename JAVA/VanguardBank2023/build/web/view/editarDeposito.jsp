    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                ...
                %>
                <h1 class="container text-center">Editar un deposito</h1>
                <form action="Controlador">
                    <strong>Monto Deposito</strong><br>
                    <input type="text" name="txtMontoDeposito" value="<%=nuevoDeposito.getMontoDeposito()%>" class="form-control"><br><br>
                    <strong>fechaDeposito</strong><br>
                    <input type="text" name="txtFechaDeposito" value="<%=nuevoDeposito.getFechaDeposito()%>" class="form-control"><br>
		    <strong>horaDeposito</strong><br>
		    <input type="text" name="txtHoraDeposito" value="<%=nuevoDeposito.getHoraDeposito()%>" class="form-control"><br>
                    <strong>Id Cuenta Origen</strong><br>
		    <input type="text" name="txtIdCuentaOrigen" value="<%=nuevoDeposito.getIdCuentaOrigen()%>" class="form-control"><br>
                    <strong>Id Cuenta Deposito</strong><br>
		    <input type="text" name="txtIdCuentaDeposito" value="<%=nuevoDeposito.getIdCuentaDeposito()%>" class="form-control"><br>
                    <input type="hidden" name="txtIdDeposito" value="<%=nuevoDeposito.getIdDeposito()%>"><br>
                    <input type="submit" name="accion" value="ActualizarDeposito" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
