    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <div>
                ...
                %>
                <h1 class="container text-center">Editar Proveedor</h1>
                <form action="Controlador">
                    <strong>Nombre:</strong><br>
                    <input type="text" name="txtNombre" value="<%=nuevoProveedor.getNombreProveedor()%>" class="form-control"><br><br>
                    <strong>Direccion:</strong><br>
                    <input type="text" name="txtDireccion" value="<%=nuevoProveedor.getDireccionProveedor()%>" class="form-control"><br><br>
                    <strong>Correo:</strong><br>
                    <input type="text" name="txtCorreo" value="<%=nuevoProveedor.getCorreoProveedor()%>" class="form-control"><br><br>
                    <strong>Telefono:</strong><br>
                    <input type="text" name="txtTelefono" value="<%=nuevoProveedor.getTelefonoProveedor()%>" class="form-control"><br><br>
                    <input type="hidden" name="txtIdProveedor" value="<%=nuevoProveedor.getIdProveedor()%>" class="form-control"><br>
                    <input type="submit" name="accion" value="ActualizarProveedor" class="form-control btn btn-warning"><br><br>
                </form>
            </div>
        </div>
        <br>
