...
<html>
    ...
    <body>
        ...
        <div class="container-sm mt-4 mb-4">
            <h1 class="container text-center">Registro de Tipo Empleados</h1>
            <a class="btn btn-primary mb-4" href="Controlador?accion=addTipoEmpleado">Agregar nuevo tipo empleado</a>
            <table border="1" class="table table-striped-columns table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="Controlador?accion=editarTipoEmpleado&idTipoEmpleado=<%= TipEm.getIdTipoEmpleado()%>">Edit</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminarTipoEmpleado&IDTIPO=<%= TipEm.getIdTipoEmpleado()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
