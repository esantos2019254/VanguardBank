...
public final class listarSucursal_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            </div>\n");
      out.write("        </nav>\n");
      out.write("        <div class=\"container-fluid mb-4 mt-4\">\n");
      out.write("            <h1 class=\"container text-center\">REGISTRO DE SUCURSALES</h1>\n");
      out.write("            <a class=\"btn btn-primary mb-4\" href=\"Controlador?accion=agregarSucu\">AGREGAR SUCURSAL</a>\n");
      out.write("            <table border=\"1\" class=\"table table-striped-columns table-bordered\">\n");
      out.write("                <thead>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>ID SUCURSAL</th>\n");
      out.write("                        <th>NOMBRE SUCURSAL</th>\n");
      out.write("                        <th>DIRECCION SUCURSAL</th>\n");
      out.write("                        <th>CORREO SUCURSAL</th>\n");
      out.write("                        <th>ID DEPARTAMENTO</th>\n");
      ...
      out.write("                ");
                    ...
                    List<Sucursal> listaDeposito = dao.listar();
                    Iterator<Sucursal> iterator = listaDeposito.iterator();
                    Sucursal sucu = null;
      ...
      out.write("                    <tr>\n");
      out.write("                        <td>");
      out.print( sucu.getIdSucursal());
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( sucu.getNombreSucursal());
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( sucu.getDireccionSucursal());
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( sucu.getCorreoSucursal());
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( sucu.getIdDepartamento());
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( sucu.getIdProveedor());
      out.write("</td>\n");
      out.write("                        <td>\n");
      out.write("                            <a class=\"btn btn-warning\" href=\"Controlador?accion=editarSucursal&idSucursal=");
      out.print(sucu.getIdSucursal());
      out.write("\">Edit</a>\n");
      out.write("                            <a class=\"btn btn-danger\" href=\"Controlador?accion=eliminarSucursal&idSucursal=");
      out.print(sucu.getIdSucursal());
